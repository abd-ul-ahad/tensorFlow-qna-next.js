  ...
  return (
    <div className="bg-[#202123] hidden text-[var(--text-color)] lg:flex flex-col justify-between text-sm px-4 py-7 h-full fixed left-0 top-0">
      <div className="h-full space-y-1">
        ...
        <button className="py-2 px-6 rounded-lg hover:bg-[var(--bg-primary)] flex justify-start items-center space-x-3">
      ...
      <hr />
      <div className="pt-5">
        <button className="py-2 px-6 rounded-lg hover:bg-[var(--bg-primary)] flex justify-between items-center space-x-3 w-full">
          <p>Abdul Ahad</p>
          <BsThreeDots color="var(--text-color)" />
        </button>
      </div>
    </div>
  );
